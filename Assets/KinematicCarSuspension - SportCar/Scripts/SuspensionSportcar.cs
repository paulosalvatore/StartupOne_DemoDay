...
public class SuspensionSportcar : MonoBehaviour
{
	...
	private void DoCamberToeCaster()
	{
		//FL
	...
	private void DoSteeringRack()
	{
		...
		otherElements.SteeringWheelAngleFloat = Mathf.MoveTowards(otherElements.SteeringWheelAngleFloat, TargetSteeringWheelAngle, SteeringSpeed * Time.fixedDeltaTime);
		...
		otherElements.SteeringCouplingAngleFloat = Mathf.MoveTowards(otherElements.SteeringCouplingAngleFloat, TargetSteeringCouplingAngle, SteeringSpeed * Time.fixedDeltaTime);
